...
#     pass
#
# q =[[0 for _ in range(Y)] for _ in range(Y)]
# print(q)


# friend_done = []
# def find_friend(p,friend_done):
#     for i in range(Y):
#         if i in friend_done:
#             continue
#         print(i)
...
for _ in range(C):
    ...
    def final(taken):
        ...
        # 처음 p 값을 0 으로 지정하고 이후 제귀에서 0으로 되도 되는 이유는
        # 어짜피 p 1즉 횟수만 추가하기 위해 아래로 내려간 제귀들은 최대 1만 반환해야함
        ret = 0
